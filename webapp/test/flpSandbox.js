		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Single Planning Calender",
									"targetURL": "#SinglePlanningCalender-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SinglePlanningCalender-display": {
								"semanticObject": "SinglePlanningCalender",
								"action": "display",
								"description": "A Fiori Single Planning Calender application.",
								"title": "Single Planning Calender",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=single.planning.cal.singleplanning",
									"url": sap.ui.require.toUrl("single/planning/cal/singleplanning")
								}
							}
						}
					}
